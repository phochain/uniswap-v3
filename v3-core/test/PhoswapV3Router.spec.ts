...
describe('PhoswapV3Pool', () => {
  ...
  let pool0: MockTimePhoswapV3Pool
  let pool1: MockTimePhoswapV3Pool
  ...
  let swapTargetCallee: TestPhoswapV3Callee
  let swapTargetRouter: TestPhoswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimePhoswapV3Pool, any]> => {
