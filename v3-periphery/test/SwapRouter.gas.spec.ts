import { abi as IPhoswapV3PoolABI } from '@uniswap/v3-core/artifacts/contracts/interfaces/IPhoswapV3Pool.sol/IPhoswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IPhoswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IPhoswapV3Pool, IPhoswapV3Pool, IPhoswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IPhoswapV3PoolABI, wallet)) as [
      IPhoswapV3Pool,
      IPhoswapV3Pool,
      IPhoswapV3Pool
    ]
  ...
  let pools: [IPhoswapV3Pool, IPhoswapV3Pool, IPhoswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestPhoswapV3Callee')
