...
import '@uniswap/v3-core/contracts/interfaces/callback/IPhoswapV3FlashCallback.sol';
...
/// @notice An example contract using the Phoswap V3 flash function
contract PairFlash is IPhoswapV3FlashCallback, PeripheryPayments {
    ...
    function initFlash(FlashParams memory params) external {
        ...
        IPhoswapV3Pool pool = IPhoswapV3Pool(PoolAddress.computeAddress(factory, poolKey));
