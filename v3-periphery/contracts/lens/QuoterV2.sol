...
contract QuoterV2 is IQuoterV2, IPhoswapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IPhoswapV3Pool) {
        return IPhoswapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IPhoswapV3SwapCallback
    function uniswapV3SwapCallback(
        ...
        IPhoswapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IPhoswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
